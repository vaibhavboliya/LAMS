...
<div class="centerbox">
    <form action={{route('admin.teachessubject')}} method="POST" class="atform">
        @csrf
        <div class="box">
            <div class = "container-fluid ">
                ...
                <div class="form-group lecture-date">
                    ...
                    <select class="form-control" style="width: 350px" name="class_id">
                        @for($i=0;$i<$count;$i++)
                            <option value={{$class_id[$i]}}>{{$class_name[$i]}}</option>
                        @endfor
                    </select>
                </div>
                <hr>
