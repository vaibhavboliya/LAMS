...
<div class="centerbox">
    <form action={{route('admin.teachesteacher')}} method="POST" class="atform">
        @csrf
        <div class="box">
            <div class = "container-fluid ">
                ...
                <div class="form-group lecture-date">
                    ...
                    <select class="form-control" style="width: 350px" name="subject_id">
                        @for($i=0;$i<$count;$i++)
                            <option value={{$subject_id[$i]}}>{{$subject_name[$i]}}</option>
                        @endfor
                    </select>
                </div>
                <hr>
